      ...
      <div className='mx-auto max-w-7xl px-4 lg:px-8 relative z-10'>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-20 mb-32">
          <div className="lg:col-span-1">
            ...
            <p className="text-muted-foreground font-light text-sm leading-relaxed mb-10 max-w-sm tracking-wide">
          ...
          <div className="grid grid-cols-2 lg:col-span-3 gap-16">
             <div>
               <h4 className="font-black text-foreground mb-10 uppercase tracking-[0.4em] text-[10px]">Tactical Suite</h4>
               <ul className="space-y-5 text-[11px] font-black text-muted-foreground uppercase tracking-widest">
                 {[
                   ...
                   <li key={link.label}><Link to={link.to} className="hover:text-primary-blue transition-colors relative group/link">{link.label}<span className="absolute -left-4 top-1/2 -translate-y-1/2 w-2 h-[1px] bg-primary-blue opacity-0 group-hover/link:opacity-100 transition-opacity" /></Link></li>
                 ))}
               </ul>
             </div>
             
             <div>
               <h4 className="font-black text-foreground mb-10 uppercase tracking-[0.4em] text-[10px]">HQ Operations</h4>
               <ul className="space-y-5 text-[11px] font-black text-muted-foreground uppercase tracking-widest">
                 {[
             ...
             <div className="col-span-2 lg:col-span-1">
                <h4 className="font-black text-foreground mb-10 uppercase tracking-[0.4em] text-[10px]">Operational Feed</h4>
                ...
                <div className="flex group/input">
                   <input 
                     ...
                     className="flex-1 bg-background border border-border border-r-0 px-6 py-4 text-[10px] font-black uppercase tracking-widest focus:outline-none focus:border-primary-blue transition-all"
                   />
        ...
        <div className="pt-16 border-t border-border flex flex-col md:flex-row items-center justify-between gap-8 text-[9px] font-black uppercase tracking-[0.4em] text-muted-foreground/50">
          <div className="flex items-center gap-4">
