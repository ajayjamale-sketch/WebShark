  ...
  return (
    ...
    >
      <div className="space-y-8 text-muted-foreground font-light leading-relaxed">
        ...
        <p>We are always looking for senior SEO engineers, data scientists, and technical architects who thrive in high-stakes environments. At WebShark, we don't just write code; we engineer dominance.</p>
        
        {/* Section 1: Open Roles Grid */}
        <div className="grid gap-6 mt-12">
           {[
             ...
             { role: 'DevOps Operative', location: 'Remote // Contract', stack: 'Terraform, AWS, CI/CD' }
           ].map((job, i) => (
             <motion.div 
               key={i}
               initial="hidden"
              ...
              <div>
                 ...
                 <div className="space-y-4">
                    {[
                      ...
                      { icon: Cpu, label: 'Neural Precision', desc: 'Advanced AI modeling for algorithmic reverse-engineering.' }
                    ].map((s, i) => (
...
fn initialize_hire(candidate: &Operative) {
    if candidate.skill_level > THRESHOLD {
        ...
        {/* Section 3: The Collective (Benefits) */}
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp} className="mt-32">
        ...
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp} className="mt-32 p-12 border border-border bg-accent/5 industrial-corner">
           <div className="grid lg:grid-cols-3 gap-12">
              <div className="lg:col-span-2">
                 ...
                 <p className="text-sm leading-relaxed mb-8">We provide our operatives with high-performance hardware and a culture of radical autonomy. We value output and technical ingenuity over bureaucratic adherence.</p>
                 <div className="flex flex-wrap gap-4">
                    {['27" Studio Monitors', 'M3 Max Standard', 'Async Workflows', 'Zero Meeting Fridays'].map(tag => (
              ...
              <div className="bg-background border border-border p-8 flex flex-col justify-center text-center">
                 ...
                 <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Operative Retention Rate</p>
              </div>
           </div>
        </motion.div>
        ...
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp} className="mt-32">
           <h3 className="font-display text-3xl font-bold uppercase tracking-tighter text-foreground mb-12">Recruitment <span className="text-primary-blue">Pipeline.</span></h3>
           <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                { step: '01', title: 'Intel Sync', desc: 'Initial 15m tactical alignment call.' },
                { step: '02', title: 'Tech Trial', desc: 'Real-world engineering challenge.' },
                { step: '03', title: 'The Board', desc: 'Deep-dive technical architectural review.' },
                { step: '04', title: 'Activation', desc: 'Deployment & contract signing.' }
              ].map((p, i) => (
                <div key={i} className="relative">
                   <span className="text-5xl font-black text-primary-blue/10 absolute -top-4 -left-2">{p.step}</span>
                   <div className="relative z-10 pt-4">
                      <h4 className="text-[10px] font-black text-foreground uppercase tracking-[0.2em] mb-2">{p.title}</h4>
        ...
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp} className="mt-40 mb-20 text-center">
           <div className="p-16 border border-primary-blue/30 bg-primary-blue/5 industrial-corner">
              <h2 className="font-display text-4xl lg:text-5xl font-bold uppercase tracking-tighter text-foreground mb-8">Initialize Your <span className="text-primary-blue">Career.</span></h2>
              <p className="text-base text-muted-foreground font-light max-w-xl mx-auto mb-12">Ready to deploy your skills at the highest level of search intelligence? Submit your technical manifesto today.</p>
